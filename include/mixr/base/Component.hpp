...
private:
   ...
   virtual bool setSlotEnableTimingStats(const Number* const);       // Sets the timing enabled flag
   virtual bool setSlotPrintTimingStats(const Number* const);        // Sets the print timing stats flag
   virtual bool setSlotFreeze(const Number* const);                  // Sets the freeze flag
   virtual bool setSlotEnableMsgType(const Identifier* const);       // Enables message types by name
   virtual bool setSlotEnableMsgType(const Number* const);           // Enables message types by bit
   virtual bool setSlotDisableMsgType(const Identifier* const);      // Disables message types by name
   virtual bool setSlotDisableMsgType(const Number* const);          // Disables message types by bit
};
